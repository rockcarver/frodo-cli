...
describe('frodo service import', () => {
    ...
    test(`"frodo service import --service-id dashboard --file ${allGlobalServicesExport}": should import the global service with the id "CorsService" from the file "${allGlobalServicesExport}"`, async () => {
        const CMD = `frodo service import --service-id CorsService --file ${allGlobalServicesExport}`;
        const { stdout } = await exec(CMD, env);
        expect(removeAnsiEscapeCodes(stdout)).toMatchSnapshot();
    });

    test(`"frodo service import --clean -g --service-id dashboard --file ${allGlobalServicesExport}": should import the global service with the id "CorsService" from the file "${allGlobalServicesExport}", and clean the old one`, async () => {
        const CMD = `frodo service import --clean -g --service-id CorsService --file ${allGlobalServicesExport}`;
        const { stdout } = await exec(CMD, env);
        expect(removeAnsiEscapeCodes(stdout)).toMatchSnapshot();
    });
    ...
    test(`"frodo service import --clean --global --file ${allGlobalServicesExport}": should import the first global service from the file "${allGlobalServicesExport}", and clean the old one`, async () => {
    ...
    test(`"frodo service import --clean --global --all --file ${allGlobalServicesExport}": should import all global services from the file "${allGlobalServicesExport}", and clean the old ones`, async () => {
