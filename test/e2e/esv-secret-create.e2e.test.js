...
describe('frodo esv secret create', () => {
    ...
    // TODO: Unskip this test (and generate mock) once pem encoded secrets can be successfully created
    test.skip('"frodo esv secret create -i esv-test-secret-pi-pem --value "3.141592653589793238462643383279502884" --description "This is a test secret containing the value pi." --encoding pem": should create an esv secret with the value of pi pem encoded', async () => {
        const CMD = `frodo esv secret create -i esv-test-secret-pi-pem --value "3.141592653589793238462643383279502884" --description "This is a test secret containing the value pi." --encoding pem`;
        const { stdout } = await exec(CMD, env);
        expect(removeAnsiEscapeCodes(stdout)).toMatchSnapshot();
    });

    // TODO: Unskip this test (and generate mock) once base64hmac encoded secrets can be successfully created
    test.skip('"frodo esv secret create -i esv-test-secret-pi-base64hmac --value "3.141592653589793238462643383279502884" --description "This is a test secret containing the value pi." --encoding base64hmac": should create an esv secret with the value of pi base64hmac encoded', async () => {
        const CMD = `frodo esv secret create -i esv-test-secret-pi-base64hmac --value "3.141592653589793238462643383279502884" --description "This is a test secret containing the value pi." --encoding base64hmac`;
        const { stdout } = await exec(CMD, env);
        expect(removeAnsiEscapeCodes(stdout)).toMatchSnapshot();
    });
