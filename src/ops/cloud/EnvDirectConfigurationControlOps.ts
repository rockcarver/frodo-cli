  ...
  try {
    ...
    if (json) {
      ...
      if (response.editable) {
        ...
        printMessage(
          `Configuration applied and direct configuration session ended. Use 'frodo dcc session init' to start a new session.`
        );
      }
    }
    return true;
  ...
  try {
    ...
    if (json) {
      ...
      if (response.editable) {
        ...
        printMessage(
          `Configuration aborted and direct configuration session ended. Use 'frodo dcc session init' to start a new session.`
        );
      }
    }
    return true;
